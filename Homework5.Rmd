...
- If merge conflicts arise, resolve them, then:
```bash
git add .
...
- `--platform linux/amd64`: force the image to target Linux/amd64 so it runs on Longleaf and avoids platform mismatch warnings on macOS
